...
# === Spaces/1967 Ferrari 330GTC (1 Bild) ===
echo "--- Spaces/1967 Ferrari 330GTC ---"
mkdir -p "$DIR/Spaces/1967-Ferrari-330GTC/reference_images"
FPATH="$DIR/Spaces/1967-Ferrari-330GTC/reference_images/20260601_1967-Ferrari-330GTC_Magnific_156.png"
if [ -f "$FPATH" ] && [ -s "$FPATH" ]; then
  ...
  if [ -f "$FPATH" ] && [ -s "$FPATH" ]; then
    ...
    echo "OK: 20260601_1967-Ferrari-330GTC_Magnific_156.png"
  else
    FAILED=$((FAILED + 1))
    echo "FAIL: 20260601_1967-Ferrari-330GTC_Magnific_156.png"
  fi
fi
