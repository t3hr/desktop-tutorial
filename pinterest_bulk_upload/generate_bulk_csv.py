...
Ablauf:
1. Bilder in pinterest_bulk_upload/images/ ablegen und per git committen/pushen
   (git add pinterest_bulk_upload/images/ && git commit -m "..." && git push),
...
REPO_OWNER = "t3hr"
REPO_NAME = "desktop-tutorial"
REPO_BRANCH = "claude/pinterest-auto-upload-script-5yl89e"
...
def _raw_url(image_path: Path) -> str:
    rel_path = f"pinterest_bulk_upload/images/{image_path.name}"
